...
class OverviewMobile extends ConsumerWidget {
  final Property property;
  const OverviewMobile({super.key, required this.property});
    ...
    return Column(
      ...
      children: [
        Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            Expanded(child: OccupancyCard(property: property)),
                ...
                children: [
                  CardButtonWidget(
                    ...
                    onPressedCallBack: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => AddTenant(currentProperty: property),
                      ),
                    ),
                  ),
                  SizedBox(height: 5),
                  CardButtonWidget(
                    ...
                    onPressedCallBack: () => Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (_) => AddUnit(currentProperty: property),
                      ),
                    ),
                  ),
                ],
        ...
        TenantInformationCardWidget(isUnitTenant: true, property: property),
      ],
    );
  }
}
